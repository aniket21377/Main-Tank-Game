...
public class GameScreen9 implements Screen {
    final FireTank game;
    ...
    public GameScreen9(final FireTank game) {
        this.game = game;
        First_Missile  = new Texture(Gdx.files.internal("Missile.png"));
        Second_Missile = new Texture(Gdx.files.internal("Missile2.png"));
        tank1Image = new Texture(Gdx.files.internal("tank5.png"));
        tank2Image = new Texture(Gdx.files.internal("tank6.png"));
    ...
    public void render(float delta)  {
        ...
        if (Gdx.input.isKeyPressed(Keys.ESCAPE)){
            game.setScreen(new resumeScreen7(game));
            dispose();
