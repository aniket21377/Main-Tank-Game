...
public class tank_selection_C implements Screen {
    ...
    public tank_selection_C(final FireTank game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, "Player 2 Please Choose your Tank", 300, 480);
        game.font.draw(game.batch, "Press A to choose tank 1", 0, 60);
        game.font.draw(game.batch, "Press B to choose tank 2", 0, 40);
        game.font.draw(game.batch, "Press C to choose tank 3", 0, 20);
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.B)){
            game.setScreen(new GameScreen8(game));
            dispose();
        }
